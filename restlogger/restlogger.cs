...
namespace Azure.Aks.Middleware.RestLogger
{
    public class RestLogger : DelegatingHandler
    {
        private readonly ILogger<RestLogger> _logger;

        public RestLogger(ILogger<RestLogger> logger)
        {
